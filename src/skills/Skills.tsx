...
export const Skills = () => {
    const skills = [
        ...
        },
        {
            ...
            img: "https://miro.medium.com/v2/resize:fit:816/1*TpbxEQy4ckB-g31PwUQPlg.png"
        }
    ]
    return (
        <div className={style.skillsBlock}>
            <div className={`${styleContainer.container} ${style.skillsContainer}`}>
                ...
                <div className={style.skills}>
                    {
                        skills.map((skill) => (
                            <Skill key={skill.id} title={skill.title} description={skill.description} img={skill.img}/>
                        ))
                    }
                </div>
            </div>
