const FooterSection = () => {
  ...
  const tgClick = () => {
    window.open('https://t.me/kxjwwb', '_blank')
  }
  const gitHubClick = () => {
    window.open('https://github.com/nxqutcq', '_blank')
  }

  return (
    <footer className="w-full bottom-0 absolute items-end bg-black justify-center">
